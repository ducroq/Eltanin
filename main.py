...
##    mw.stageZTranslation.valueChanged.connect(lambda z: ph.gotoZ(z))
    mw.stageXTranslation.valueChanged.connect(lambda x: ph.sendGcode("G1 X{:.3f}".format(x)))
    mw.stageYTranslation.valueChanged.connect(lambda y: ph.sendGcode("G1 Y{:.3f}".format(y)))
    mw.stageZTranslation.valueChanged.connect(lambda z: ph.sendGcode("G1 Z{:.3f}".format(z)))
